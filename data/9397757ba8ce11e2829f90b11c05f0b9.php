    ...
    'clientScriptInternalPackages' => array(
        ...
        '_ajax_packages_toolbar' => array(
            'js' => array(
                ...
                'js/views/ActivityTooltipBannerView.js',
                'js/models/ActivityTooltipBanner.js',
            ),
            'js_templates' => array(
                'ActivityTooltipBannerTemplate.js',
            ),
            'messages' => array(
                'activity-tooltip-banner-template.js',
            ),
        ),
        ...
        'countdown_package' => array(
            'js' => array(
                'plugins/jquery-countdown/jquery.countdown.js',
            ),
        ),
